const mongoResult = (results, fastLap) => {
    const { result1, result2, result3, result4, hardCharge1, hardCharge2, hardCharge3, series } = results;
    return {
        ...results,
        series: series.name,
        fastLap: { ...fastLap, entry: { ...fastLap.entry } },
        ...(hardCharge1 ? { hardCharge1: hardCharge1 } : {}),
        ...(hardCharge2 ? { hardCharge1: hardCharge2 } : {}),
        ...(hardCharge3 ? { hardCharge1: hardCharge3 } : {}),
