    ...
    return (
        <>
            <TableRow sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                ...
                <TableCell align="right">{entry.driver2 ? entry.driver2.name : ""}</TableCell>
                <TableCell align="right">{entry.driver3 ? entry.driver3.name : ""}</TableCell>
                <TableCell align="right">{entry.vehicle}</TableCell>
                <TableCell align="right">{entry.classification}</TableCell>
                <TableCell align="right">{entry.event}</TableCell>
