import { FormControl, InputLabel, Select, TextField, Button, Card, Box, MenuItem } from "@mui/material";
            ...
            <Card className="podium_card">
                ...
                <Box className="hard_charger__input podium_card__input">
                    <TextField
                        ...
                        onChange={handleChange}
                    />
                    <TextField id="outlined" label="Gain" name="gain" value={hardCharge.gain} onChange={handleChange} />
                </Box>
                <Button variant="contained" color={isSubmitted ? "success" : "error"} onClick={handleClick}>
